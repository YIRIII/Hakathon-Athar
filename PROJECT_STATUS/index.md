...
- [Phase 3: AI Heritage Chatbot](docs/planning/phase-3-ai-chatbot.md) — COMPLETE
...
## Project Documents (read-only research snapshot)
- [Plan Manifest](project_documents/plan-manifest.md) — research snapshot metadata
- [IDEA.md](project_documents/IDEA.md) | [BRD.md](project_documents/BRD.md) | [PRD.md](project_documents/PRD.md)
- [BUSINESS_RESEARCH/](project_documents/BUSINESS_RESEARCH/) (11 features)
- [TECHNICAL_OPTIONS/](project_documents/TECHNICAL_OPTIONS/) (11 capabilities)
- [SUPPORTING_SYSTEMS/](project_documents/SUPPORTING_SYSTEMS/) (6 systems)
- [MARKETING_STRATEGY/](project_documents/MARKETING_STRATEGY/) (5 phases)
- [DOMAIN_RESEARCH/](project_documents/DOMAIN_RESEARCH/) (3 studies)
